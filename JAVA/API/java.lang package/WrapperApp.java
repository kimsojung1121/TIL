...
//		Integer number=50;
		...
		System.out.println("su(10진수) = "+number);
		//Integer.toOctalString(int i) : 전달받은 정수값을 8진수의 문자열로 변환하여 반환하는 메소드
		System.out.println("su(8진수) = "+Integer.toOctalString(number));
		//Integer.toHexString(int i) : 전달받은 정수값을 16진수의 문자열로 변환하여 반환하는 메소드
		System.out.println("su(16진수) = "+Integer.toHexString(number));
		//Integer.toBinaryString(int i) : 전달받은 정수값을 2진수의 문자열로 변환하여 반환하는 메소드
		System.out.println("su(2진수) = "+Integer.toBinaryString(number));
		System.out.println("======================================================");
		...
		// => 실행시 전달받은 문자열이 정수값으로 변환되지 못할 경우 NumberFormatException 발생 가능
