...
INSERT INTO USER2 VALUES('KIM','전우치',NULL); --명시적 NULL 저장
...
CREATE TABLE USER3(ID VARCHAR2(20),NAME VARCHAR2(30),PHONE VARCHAR2(15),CONSTRAINT USER3_ID_UK UNIQUE(ID),CONSTRAINT USER3_PHONE_UK UNIQUE(PHONE));
...
-- >> UNIQUE 제약조건을 테이블 수준의 제약조건으로 설정
CREATE TABLE USER4(ID VARCHAR2(20),NAME VARCHAR2(30),PHONE VARCHAR2(15),CONSTRAINT USER4_ID_UK UNIQUE(ID,PHONE));
